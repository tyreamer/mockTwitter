...
$fgmembersite->RedirectToURL("index.php"); // DEAD PAGE
...
e			else if (!bitroadLinkFilter.test(linkTrimmed)) { //test for format
				link.style.background = 'Red';
				document.getElementById('link-error').innerHTML = "Please enter a URL from Bitroad.";
				var error = "4";
			}
			else {
