...
<head>
	...
	<title>Leyff | <?php echo $selectedUser ?>'s Followers </title>
...
<body>
	  ...
	  <div class="col-sm-10 col-sm-offset-1">
		<div class="row" style="text-align: center; margin-top: 2%;"><h2><a style="color: black; font-weight: bold;" href="profile.php?user=<?php echo $selectedUser ?>"><?php echo $fgmembersite->GetNameFromConnectName($selectedUser) ?></a>'s Followers</h2></div>
		<hr/>
		<div class="col-sm-10 col-sm-offset-1">
   ...
   <script>
	   $(function() {
		...
		function loadFollowers(){	
			...
			$.ajax({											
					type: "POST",
					url: "loadMoreFollowers.php",
					data: {user : user},
					cache: false,
					success: function(msg){
								$('#followers' ).append( msg );
